...
\begin{document}
    ...
    \begin{frame}{Nodes}
        \begin{itemize}
            ...
            %\begin{itemize}
            %    \item Node addressing \medskip
            %    \item CIDR ranges \medskip
            %\end{itemize}
            \item Initialize IPAM \medskip
            \item Configure node-level access\medskip
            %\begin{itemize}
            %    \item Tunnels \medskip
            %    \item Masquerade \medskip
            %\end{itemize}
            %\item Building BPF templates
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Datapath Configuration}
        ...
        \begin{figure}
        \begin{overprint}
            \onslide<1>\includesvg[scale=0.9]{cilium-bpf-egress.svg}
            \onslide<2>\includesvg[scale=0.9]{cilium-bpf-egress-proxy.svg}
        \end{overprint}
        \end{figure}
        \vfill
    \end{frame}
